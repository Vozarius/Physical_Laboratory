...
struct FCartesianAxisConfig
{
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Axis", Meta = (ClampMin = "0.1", ClampMax = "10"))
	float MarkerSpacing;

	/*
	Specifies the maximum number of digits which can be displayed on an axis marker.
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Axis", Meta = (ClampMin = "1", ClampMax = "10"))
	int32 MaxValueDigits;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Axis", Meta = (DisplayName = "Left/Bottom Axis"))
	FCartesianAxisInstanceConfig LeftBottomAxis;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Axis", Meta = (DisplayName = "Right/Top Axis"))
